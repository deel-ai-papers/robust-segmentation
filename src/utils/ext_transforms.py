...
class ExtBinaryLabels(object):
    ...
    def __call__(self, img, lbl):
        ...
        """
        lbl = (lbl > 128).long()
        # lbl = torch.nn.functional.one_hot(lbl, num_classes=2)
        # lbl = torch.permute(lbl, (2, 0, 1))
        return img, lbl
...
class ExtRandomRotation(object):
    ...
    def __init__(
        self, degrees, resample=False, expand=False, center=None, ignore_index=None
    ):
